...
def _get_api_base() -> str:
    ...
    v = v.rstrip("/")
    # Allow passing server root like http://127.0.0.1:8000
...
def test_api_get(path):
    ...
    try:
        ...
        # Avoid emojis: Windows console might be GBK/cp936 and crash on unicode symbols.
